...
import as.mke.xyq.sprite.Sprite;
...
public class SpriteFactory {
    ...
    private static TCPImageDecoder createDecoder(String filename, int[] colorations) throws Exception {
    ...
    public static LTexture[] loadAnimationAsBitmap(String filename, int index) {
